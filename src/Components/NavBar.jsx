...
//<div className=" hiddeen md-flex mx-2 flex  justify-between items-center md:flex-row flex-col">
{
  /* Left Section */
}
...
//     <Link
//       to="/"
//       className="hidden md:flex items-center space-x-1 hover:text-gray-300"
//     >
